...
if (import.meta.env.VITE_APP_BLOCKCHAIN_URL) {
    console.log(`Using BLOCKCHAIN_URL from env:  ${import.meta.env.VITE_APP_BLOCKCHAIN_URL}`);
    config.blockchainUrl = import.meta.env.VITE_APP_BLOCKCHAIN_URL;
}

if (import.meta.env.VITE_APP_TONOMY_ID_LINK) {
    console.log(`Using TONOMY_ID_LINK from env:  ${import.meta.env.VITE_APP_TONOMY_ID_LINK}`);
    config.tonomyIdLink = import.meta.env.VITE_APP_TONOMY_ID_LINK;
}

if (import.meta.env.VITE_APP_COMMUNICATION_URL) {
    console.log(`Using communication microService from env: ${import.meta.env.VITE_APP_COMMUNICATION_URL}`);
