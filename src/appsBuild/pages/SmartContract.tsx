...
export default function SmartContract() {
  ...
  const handlePurchaseRAM = async () => {
    if (username && smartContract && ramAmount > 0) {
      await updateSmartContractRAM(
        username,
        smartContract.ramPurchasedMB + ramAmount,
      );
    }
  };
  ...
  const handleSellRAM = async () => {
    if (username && smartContract && ramAmount > 0) {
      const maxSellable =
        smartContract.ramPurchasedMB - smartContract.ramUsedMB;
      ...
      <>
        <div className="smart-contract">
          <section className="sc-section sc-intro">
            ...
            <p>
              Deploy and manage smart contracts on the Tonomy blockchain using
              the Tonomy ID SDK.
            </p>
            <button
        ...
        >
          <div className="upgrade-modal">
            ...
            <p className="modal-description">
              Smart contract deployment is only available for PRO users. Please
              update your billing plan to deploy your first smart contract
            </p>
  ...
  return (
    <div className="smart-contract">
      <section className="sc-section sc-intro">
        ...
        <p>
          Manage your app's smart contract lifecycle. Power your app with
          on-chain logic, ensure security, and streamline upgrades
        </p>
      </section>
          ...
          <section className="sc-section">
            <div className="contract-card">
              ...
              <h4 className="contract-name">
                Contract v{smartContract.version}
              </h4>
              <div className="contract-details">
                ...
                <div className="detail-row">
                  ...
                  <span className="detail-value">
                    {formatAppUsername(app.ownerUsername)}
                  </span>
                </div>
                <div className="detail-row">
                  ...
                  <span className="detail-value">
                    ...
                    <IconButton
                      ...
                      onClick={() =>
                        window.open(
                          `https://explorer.tonomy.io/account/${app.accountName}`,
                          "_blank",
                        )
                      }
              ...
              {smartContract.sourceCodeUrl && (
                <a
                  href={smartContract.sourceCodeUrl}
                  target="_blank"
            ...
            <div className="ram-card">
              <div className="ram-info">
                ...
                <span className="ram-values">
                  {smartContract.ramUsedMB} MB / {smartContract.ramPurchasedMB}{" "}
                  MB
                </span>
              </div>
              ...
              <div className="ram-adjust">
                <label className="ram-adjust-label">
                  Storage Capacity (MB)
                </label>
