  ...
  return (
    ...
    >
      <div className="preview-content">
            ...
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src =
                  "https://via.placeholder.com/94?text=Logo";
              }}
            />
          ) : (
        ...
        <div
          className="preview-detail-container"
          style={{
        ...
        >
          <div className="preview-qr-section">
            <div className="preview-qr-sub-container">
              <h3 className="preview-qr-title">Log in with Tonomy ID</h3>
            </div>
            ...
            <ol className="preview-qr-list">
              <li>
                Download <span style={{ color: accentColor }}>Tonomy ID</span>
              </li>
              <li>Create an account</li>
              <li>
                Scan <span style={{ color: accentColor }}>QR code</span>
              </li>
            </ol>
          </div>
        ...
        <div className="preview-secure-info">
          ...
          <span>
            Tonomy uses end-to-end cryptography. We cannot see your personal
            data
          </span>
        </div>
      </div>
